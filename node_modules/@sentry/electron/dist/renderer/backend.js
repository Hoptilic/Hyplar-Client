...
var RendererBackend = /** @class */ (function (_super) {
    ...
    RendererBackend.prototype._hookIPC = function (ipcRenderer, contextBridge) {
        var ipcObject = {
            ...
            sendScope: function (scope) { return ipcRenderer.send(common_1.IPC_SCOPE, JSON.stringify(scope, walk)); },
            sendEvent: function (event) { return ipcRenderer.send(common_1.IPC_EVENT, JSON.stringify(event, walk)); },
            pingMain: function (success) {
                ipcRenderer.once(common_1.IPC_PING, function () {
                    success();
                });
                ipcRenderer.send(common_1.IPC_PING);
            },
        };
