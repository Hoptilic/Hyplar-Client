...
var RendererBackend = /** @class */ (function (_super) {
    ...
    RendererBackend.prototype._hookIPC = function (ipcRenderer, contextBridge) {
        var ipcObject = {
            ...
            sendScope: function (scope) { return ipcRenderer.send(IPC_SCOPE, JSON.stringify(scope, walk)); },
            sendEvent: function (event) { return ipcRenderer.send(IPC_EVENT, JSON.stringify(event, walk)); },
            pingMain: function (success) {
                ipcRenderer.once(IPC_PING, function () {
                    success();
                });
